...
SFR(0x9C, T2EVTCFG)
SFR(0x9D, SLEEPSTA)
SFRBIT(0x9E, CLKCONSTA, OSC32KSTA, OSCSTA, TICKSPD_2STA, TICKSPD_1STA, TICKSPD_0STA, CLKSPD_2STA, CLKSPD_1STA, CLKSPD_0STA)
SFR(0x9F, FMAP)
...
SFR(0xB2, ENCDO)
SFR(0xB3, ENCCS)
SFRBIT(0xB4, ADCCON1, EOC, STOC, STSEL_1, STSEL_0, RNGCON_1, RNGCON_0, ADCCONR_1, ADCCONR_0)
SFR(0xB5, ADCCON2)
SFR(0xB6, ADCCON3)
//  0xB7
...
SFR(0xC4, U0UCR)
SFR(0xC5, U0GCR)
SFRBIT(0xC6, CLKCON, OSC32K, OSC, TICKSPD_2, TICKSPD_1, TICKSPD_0, CLKSPD_2, CLKSPD_1, CLKSPD_0)
SFR(0xC7, MEMCTR)
